...
class ConsoleWidget(QtGui.QWidget):
    ...
    def runCmd(self, cmd):
        ...
        try:
            ...
            if self.multiline is not None:
                ...
                self.write("<br><div style='background-color: #373737; color: #00BFFF'><b>%s</b>\n"%encCmd, html=True, scrollToBottom=True)
                self.inCmd = True
                self.execSingle(cmd)
    ...
    def write(self, strn, html=False, scrollToBottom='auto'):
        ...
        if html:
            ...
            if self.inCmd:
                self.inCmd = False
                self.output.textCursor().insertHtml("</div><br><div style='font-weight: normal; background-color: black; color: #0489B1'>")
